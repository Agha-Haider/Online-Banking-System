...
public class UserHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert Into Table
        db.execSQL("insert into " + TABLE_NAME + " values(7860,'Agha Haider', 'aa4571756@gmail.com','7584','03043411862', 15000)");
        db.execSQL("insert into " + TABLE_NAME + " values(5862,'Hosh Muhammad', 'muzamil21@gmail.com','1258','03338380221', 5000)");
        db.execSQL("insert into " + TABLE_NAME + " values(7895,'Muzamil Dayo', 'aghah880@gmail.com','8896','03012213330', 1000)");
        db.execSQL("insert into " + TABLE_NAME + " values(1258,'Fahad Umar', 'fumar554@gmail.com','7752','03022234332', 8000)");
        db.execSQL("insert into " + TABLE_NAME + " values(7410,'Asif Ali', 'noor44@gmail.com','3669','03055432008', 7500)");
        ...
        db.execSQL("insert into " + TABLE_NAME + " values(2365,'Anum', 'sana1010@gmail.com','5450','03055954771', 9900)");
